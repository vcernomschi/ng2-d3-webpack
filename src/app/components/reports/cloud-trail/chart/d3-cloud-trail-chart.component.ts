...
@Component({
    selector: 'd3-cloud-trail-chart',
    templateUrl: './d3-cloud-trail-chart.html',
    styleUrls: ['./d3-cloud-trail-chart.css']
})
export class D3CloudTrailChartComponent implements OnInit, OnDestroy {

private d3: D3; // <-- Define the private member which will hold the d3 reference
private parentNativeElement: any;
private d3Svg: Selection<SVGSVGElement, any, null, undefined>;

public chartTitle: string = 'd3-cloud-trail-chart here';
